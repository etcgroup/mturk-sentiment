...
function bigbreath() {
    ...
    $('#box').animate({'background-color' : '#f44'},
                      {'duration' : hold_time - 50,
                       'easing' : 'linear'});
    $('#boxprogress').animate({'background-color' : '#f44'},
                      {'duration' : hold_time - 50,
                       'easing' : 'linear'});
...
function update_score() {
    $('#youscore').html(winscore -(youscore + compscore) + '');
    $('#boxprogress').animate({'height' : Math.ceil((youscore / winscore) * 100) + '%'});
...
function newgame() {
    time_left = swim_time[swim_level];
    winscore = swim_clicks[swim_level];
